{
  ...
  Instead, in another unit add "u_sprite_labelready" in the uses clause
  and add your code in a class inherited from TLabelReady.
...
constructor TLabelReady.Create(aLayerIndex: integer);
begin
